<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="LibrarySystem.UserLogin" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="使用者登入" Style="font-size:20px; font-weight:bold; margin-bottom:20px;"></asp:Label><br />
